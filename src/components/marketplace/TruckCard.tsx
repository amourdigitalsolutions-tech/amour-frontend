...
export default function TruckCard({ id, image, title, mileage, fuelType, price }: TruckCardProps) {
  return (
    <div className="bg-white rounded-lg shadow-sm border border-slate-100 flex flex-col overflow-hidden group font-inter">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-xs">
            <span className="block text-slate-400 font-medium mb-1">Mileage</span>
          ...
          <div className="text-xs">
            <span className="block text-slate-400 font-medium mb-1">Fuel Type</span>
            <div className="flex items-center gap-1 font-semibold text-slate-700">
